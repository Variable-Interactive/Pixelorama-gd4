...
@onready var canvas_preview = $HBoxContainer/PreviewViewportContainer/SubViewport/CanvasPreview
@onready var camera: Camera2D = $HBoxContainer/PreviewViewportContainer/SubViewport/CameraPreview
